        ...
        fs.readdir(`./addons/${a.type}/`, (err, items) => {
            ...
            inquirer
                ...
                .then(answer => {
                    ...
                    zipFolder(addonFile.path, `./exports/${addonFile.baseName.toLowerCase().replace(' ', '-')}.c3addon`, function (err) {
                        if (err) {
                            console.log('Error occured:', err);
                        }
                        else {
                            console.log('Successfully exported .c3addon: ' + path.resolve(`./exports/${addonFile.baseName.toLowerCase().replace(' ', '-')}.c3addon`));
                        }
                    });
                });
        });
